...
//  Quizzler
//
//  Created by Catherine Looper on 5/8/18.
...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "Chocolate affects a dog\'s heart and nervous system; a few ounces are enough to kill a small dog.", correctAnswer: true))    // Creating a
    }
}
